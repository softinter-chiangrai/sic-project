...
namespace sic_api.Migrations
{
    ...
    public partial class Initial_Struct_Database : Migration
    {
        ...
        {
            // 1. ลบตาราง "ลูกสุด" ที่พึ่งพาชาวบ้านออกให้หมดก่อน
            migrationBuilder.DropTable(name: "su_user_business_role"); // ผูกกับ su_user_business และ su_business_role
            migrationBuilder.DropTable(name: "su_business_role_program"); // ผูกกับ su_business_role และ su_program
            migrationBuilder.DropTable(name: "su_business_invite"); // ผูกกับ su_business_role
            migrationBuilder.DropTable(name: "db_mail_queue");      // ผูกกับ db_mail_template และ db_mail_config
            migrationBuilder.DropTable(name: "su_user_task");       // ผูกกับ su_task

            // 2. ลบตารางระดับ "ลูกชั้นที่สอง" หรือตารางแชร์
            migrationBuilder.DropTable(name: "su_user_business");   // ผูกกับ su_business
            migrationBuilder.DropTable(name: "su_business_role");   // ผูกกับ su_business

            // 3. ลบตารางที่พึ่งพาโครงสร้างที่อยู่ (Address)
            migrationBuilder.DropTable(name: "su_profile");
            migrationBuilder.DropTable(name: "su_business");        // ผูกกับ db_country, db_province, db_district, db_sub_district

            // 4. ลบตารางระบบที่เหลือ (Standalone / แม่)
            migrationBuilder.DropTable(name: "db_parameter");
            migrationBuilder.DropTable(name: "ex_example");
            migrationBuilder.DropTable(name: "su_business_audit");
            migrationBuilder.DropTable(name: "su_message");
            migrationBuilder.DropTable(name: "su_upload");
            migrationBuilder.DropTable(name: "su_verify");
            migrationBuilder.DropTable(name: "db_mail_config");
            migrationBuilder.DropTable(name: "db_mail_template");
            migrationBuilder.DropTable(name: "su_program");
            migrationBuilder.DropTable(name: "su_task");

            // 5. ลบตารางกลุ่ม Address เรียงจากย่อยสุดไปหาใหญ่สุด (Sub_district -> District -> Province -> Country)
            migrationBuilder.DropTable(name: "db_sub_district");
            migrationBuilder.DropTable(name: "db_district");
            migrationBuilder.DropTable(name: "db_province");
            migrationBuilder.DropTable(name: "db_country");
            migrationBuilder.DropTable(name: "db_title");
        }
    }
}
