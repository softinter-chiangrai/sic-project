...
VALUES
    ...
    ('b0000006-0000-0000-0000-000000000006', '2521a502-bfaa-4385-8e94-d255d0fcba6b', 'PMDT06', 'bi bi-arrow-left-right', 'Change Control', 'ควบคุมการเปลี่ยนแปลง (CR)', 'pm/change-request', 60, true, false, false, false, false, false, false, false, 'system', NOW(), 'system', NOW()),
