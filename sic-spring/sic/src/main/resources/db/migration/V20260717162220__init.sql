...
CREATE TABLE IF NOT EXISTS pm_diagram (
    ...
    graph_data JSONB DEFAULT '{}'::jsonb,  -- เพิ่มคอลัมน์สำหรับข้อมูลกราฟเพิ่มเติม
...
CREATE INDEX IF NOT EXISTS idx_diagram_graph ON pm_diagram USING GIN (graph_data);  -- เพิ่ม index สำหรับ graph_data
