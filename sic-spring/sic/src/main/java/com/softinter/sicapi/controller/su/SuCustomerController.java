...
public class SuCustomerController {
    ...
    public ResponseEntity<SuCustomerResponse> create(
    ...
    public ResponseEntity<SuCustomerResponse> update(
    ...
    public ResponseEntity<SuCustomerResponse> getByCode(
            @RequestParam UUID businessId,
    ...
    public ResponseEntity<Page<SuCustomerResponse>> getAll(
            @RequestParam UUID businessId,
    ...
    public ResponseEntity<Page<SuCustomerResponse>> search(
            @RequestParam UUID businessId,
