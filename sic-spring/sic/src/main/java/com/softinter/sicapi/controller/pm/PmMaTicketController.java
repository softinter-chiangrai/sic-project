...
public class PmMaTicketController {
    ...
    public ResponseEntity<PaginationResponse<PmMaTicketResponse>> getPaging(
        ...
        Page<PmMaTicketResponse> pageResult = ticketService.findAll(businessId, projectId, pageable);
