...
-- 1. Ensure USER_MANUAL exists in db_parameter (DOCUMENT_TYPE)
...
WHERE NOT EXISTS (
    SELECT 1 FROM db_parameter WHERE module_code = 'PM' AND parameter_code = 'DOCUMENT_TYPE' AND parameter_value = 'USER_MANUAL'
);
