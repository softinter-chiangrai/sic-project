...
import { SicButtonComponent, SicInputComponent, SicColorpickerComponent} from 'sic-ng';
...
@Component({
  ...
  template: `
    ...
    >
      ...
      <sic-button variant="outline" size="sm">Cancel</sic-button>
      <sic-button variant="solid" color="primary" size="sm" type="submit">Save</sic-button>
      </div>
    </div>
  `,
})
