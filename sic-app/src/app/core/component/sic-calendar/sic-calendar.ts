...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, SicInput, SicInputArea, SicColorpicker, SicButton],
  template: `
    <div
...
@Component({
  ...
  templateUrl: './sic-calendar.html',
  styleUrl: './sic-calendar.css',
  host: {
    ngSkipHydration: 'true',
  },
})
export class SicCalendar implements OnInit, OnDestroy, OnChanges {
  @Input() label?: string;
