...
import { SicEntityState, SicUploadCategory, SicUploadItem, StorageUploadReference } from '../sic-upload/sic-upload';
...
@Component({
  ...
  templateUrl: './sic-input-upload.html',
  styleUrl: './sic-input-upload.css',
  host: {
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SicInputUpload),
      multi: true,
    },
  ],
})
export class SicInputUpload implements ControlValueAccessor, OnInit, OnDestroy {
  @Input() label?: string;
