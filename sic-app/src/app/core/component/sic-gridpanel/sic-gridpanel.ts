...
import { SicNumber } from '../sic-number/sic-number';
import { SicInputArea } from '../sic-input-area/sic-input-area';
import { SicCheckbox } from '../sic-checkbox/sic-checkbox';
import { SicDatepicker } from '../sic-datepicker/sic-datepicker';
import { SicTimepicker } from '../sic-timepicker/sic-timepicker';
import { SicCombobox } from '../sic-combobox/sic-combobox';
import { SicRadio, SicRadioOption } from '../sic-radio/sic-radio';
import { SicColorpicker } from '../sic-colorpicker/sic-colorpicker';
import { SicInputUpload } from '../sic-input-upload/sic-input-upload';
import { SicUploadCategory } from '../sic-upload/sic-upload';
...
@Component({
  ...
  providers: [DatePipe],
  templateUrl: './sic-gridpanel.html',
  styleUrl: './sic-gridpanel.css',
})
export class SicGridPanel implements OnChanges, AfterContentInit, AfterViewInit, OnDestroy {
