...
import { SicCalendar, SicCalendarTask, SicCalendarViewRange } from '../sic-calendar/sic-calendar';
...
@Component({
  selector: 'sic-task',
  standalone: true,
  imports: [CommonModule, SicCalendar],
  templateUrl: './sic-task.html',
  styleUrl: './sic-task.css',
})
export class SicTask implements OnChanges, AfterViewInit {
