...
@Component({
  ...
  templateUrl: './sic-timepicker.html',
  styleUrl: './sic-timepicker.css',
  host: {
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SicTimepicker),
      multi: true,
    },
  ],
})
export class SicTimepicker implements ControlValueAccessor, OnInit, AfterViewInit, OnDestroy {
  @Input() label?: string;
