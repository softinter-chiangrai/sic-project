...
import { SicProfileCropperComponent } from './sic-profile-cropper.component';
import { SicEntityState, StorageUploadReference } from '../sic-upload/sic-upload.component';
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SicProfileComponent),
      multi: true,
    },
  ],
})
export class SicProfileComponent implements ControlValueAccessor, OnInit, OnDestroy {
  ...
  private async openCropDialog(): Promise<void> {
    ...
    await this.dialogService.open({
      type: 'info',
      component: SicProfileCropperComponent,
      componentInputs: {
        src: this.preview,
