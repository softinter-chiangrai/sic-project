...
@Component({
  ...
  templateUrl: './sic-input-area.html',
  styleUrl: './sic-input-area.css',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SicInputArea),
      multi: true,
    },
  ],
})
export class SicInputArea implements ControlValueAccessor, OnInit {
  @Input() label?: string;
  @Input() name?: string;
  @Input() placeholder = '';
  @Input() hint?: string;
