...
import { Pmdt21AService } from './pmdt21A.service';
import { Pmdt21AForm } from './pmdt21A.form';
import { PmMaTicketModel } from './pmdt21A.model';
import { apiBaseUrl } from '../../../../../core/config/api.config';

@Component({
  selector: 'app-pmdt21a',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './pmdt21A.component.html',
  changeDetection: ChangeDetectionStrategy.Default,
})
export class Pmdt21AComponent implements OnInit, CanComponentDeactivate {
  private service = inject(Pmdt21AService);
