...
import { SicDatepicker } from '../core/component/sic-datepicker/sic-datepicker';
import { SicTimepicker } from '../core/component/sic-timepicker/sic-timepicker';
import { SicColorpicker } from '../core/component/sic-colorpicker/sic-colorpicker';
import { SicCheckbox } from '../core/component/sic-checkbox/sic-checkbox';
...
import { SicGridPanel, SicGridPanelConfig, SicGridPanelTemplate } from '../core/component/sic-gridpanel/sic-gridpanel';
import { SicUpload } from '../core/component/sic-upload/sic-upload';
import { SicOrganizationalChart } from '../core/component/sic-organizational-chart/sic-organizational-chart';
...
export class Feature {
  ...
  organizationData = signal<SicOrganizationalChartNode>({
	"id": "",
	"name_en": "Admin",
	"name_local": "ผู้ดูแลระบบ",
	"color": "#FF6B6B",
	"children": [
		{
			"id": "118fdacb-7f5f-48c1-9f38-cd25962f1ca5",
			"name_en": "Project Manager",
			"name_local": "ผู้จัดการโครงการ",
			"color": "#AF7BEF",
			"children": [
				{
					"id": "fae6b36f-f316-42d3-9c54-179ffc5a2470",
					"name_en": "system analyst",
					"name_local": "นักวิเคราะห์ระบบ",
					"color": "#97E2D6",
					"children": [
						{
							"id": "62d58fef-df01-4e75-ae32-ee2ea3c15648",
							"name_en": "Senior Developer",
							"name_local": "นักพัฒนาซอฟต์แวร์อาวุโส",
							"color": "#CD88E2",
							"children": [
								{
									"id": "a1b4c637-1697-479a-8d55-9c80bc9898b1",
									"name_en": "Developer",
									"name_local": "นักพัฒนาซอฟต์แวร์",
									"color": "#CCA3CC",
									"children": []
								}
							]
				...
				},
        {
			...
			"name_en": "Project Executive",
			"name_local": "เจ้าหน้าที่บริหารโครงการ",
			"color": "#F089D7",
			"children": [
				{
					"id": "2d193767-7345-4fcd-ac8e-cb9572f9261d",
					"name_en": "Project Coordinator (PC)",
					"name_local": "ผู้ประสานงานโครงการ",
					"color": "#E7DD84",
					"children": []
				}
			]
